...
if not SECRET_KEY:
    ...
    # Provide a deterministic default for local development to avoid
    # passing None to jose which raises a JWKError.
    # WARNING: replace with a secure value in production by setting
    # the SECRET_KEY environment variable.
    DEFAULT_DEV_SECRET = "dev-secret-change-me"
    SECRET_KEY = DEFAULT_DEV_SECRET
    logging.getLogger("uvicorn.error").warning(
        "SECRET_KEY not set; using insecure default for development. Set SECRET_KEY in .env for production."
    )
